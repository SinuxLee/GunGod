...
cc.Class({
    ...
    appLinkReport: function(e) {
        if (facade.isMiniGame) {
            ...
            var i = "",
                o = 0;
            for (var a in this.reqData) o > 0 && (i += "&"), o++, i += a + "=" + this.reqData[a];
            var s = window.facade.appLinkReportAdress;
    ...
    request: function(e, t) {
        var n = "",
            i = 0;
        for (var o in t) i > 0 && (n += "&"), i++, n += o + "=" + t[o];
    ...
    requestQQApi: function(e, t) {
        var n = window.facade.openapiUrl + e,
            i = [];
        ...
        var a = i.join("&"),
            s = ["GET", this.urlencode(e), this.urlencode(i.join("&"))].join("&"),
            c = CryptoJS.HmacSHA1(s, window.facade.qqAppKey + "&").toString(CryptoJS.enc.Base64);
    ...
    requestUrl: function(e, t, n, i, o) {
        if (null != e && "" != e) {
            ...
            console.log("requestUrl", e), n ? (s.open("POST", e, !0), s.setRequestHeader("Content-Type", "application/x-www-form-urlencoded")) : s.open("GET", a, !0), s.onerror = function() {
                null != i && 1 == s.readyState && s.status
            }, s.onreadystatechange = function() {
                4 == s.readyState && (200 == s.status ? "arraybuffer" == o ? (s.responseType = o, this.dealResponseAb(s.response)) : this.dealResponseJson(JSON.parse(s.responseText)) : i && i(s.status))
            }.bind(this), facade.isMiniGame && (s.timeout = 5e3), null == t || "" == t ? s.send() : s.send(t)
        }
    },
    getParamString: function(e) {
        var t = "";
        for (var n in e) t += "{0}={1}&".format(n, e[n]);
