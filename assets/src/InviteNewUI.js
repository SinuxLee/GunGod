...
cc.Class({
    ...
    initContent: function() {
        for (var e = facade.getComponent("GameModel").newbieFetchList, t = 0; t < 4; t++) {
            var n = cc.instantiate(this.item);
            null != e[t] ? n.getComponent("InviteDailyItem1").setItemData(t, e[t]) : n.getComponent("InviteDailyItem1").setItemData(t, null), this.content.addChild(n)
        }
    },
    onClickInvite: function() {
        ...
        window.facade.getComponent("ShareADModel").showShareAD(e, {
            succ: function(e) {
                ...
                var t = facade.getComponent("GameModel").newbieFetchList;
