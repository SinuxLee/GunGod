cc.Class({
    ...
    setItemData: function(e, t) {
        ...
        var n = facade.getComponent("ShareADModel").GameConfig.InviteB;
        if (this.title.string = "第" + (e + 1) + "个好友", this.rewardCount.string = "x" + n.Value, this.showImg = this.node.getChildByName("cash"), this.showImg.active = !0, null == t) this.now.active = !1, this.mask.active = !0, this.isget.active = !1;
        else {
            var i = facade.getComponent("GameModel").newbieFetchList;
