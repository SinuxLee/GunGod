...
//截图 链接：https://share.weiyun.com/leGAHpnB 密码：b9udtv
    ...
    onBeginContact: function(e, t, n) {
        "prop" == t.node.group && "body" == n.node.group && (cc.v2(t.body._b2Body.m_linearVelocity.x - n.body._b2Body.m_linearVelocity.x, t.body._b2Body.m_linearVelocity.y - -n.body._b2Body.m_linearVelocity.y).mag() > 2 && this.killSuffer(n.node))
    },
