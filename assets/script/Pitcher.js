...
cc.Class({
  ...
  onLoad: function () {
    this.isInUI || (this.aim = new cc.Node(), this.aim.addComponent(cc.Sprite), this.aim.getComponent(cc.Sprite).spriteFrame = cc.loader.getRes('roles', cc.SpriteAtlas).getSpriteFrame('aim'), this.handGun.addChild(this.aim, 999), this.aim.active = !1, this.aim.scale = 0.5, this.aim.y = 10)
  },
  start: function () {
  ...
  onTouchMove: function (e) {
    ...
    if (this._inTouch) {
      ...
      for (i = 0; i < o; i++) {
        ...
        this.powerLine.addChild(a), this.powerPoints.push(a), a.scale = 1 + 0.25 * i
      }
    }
  },
