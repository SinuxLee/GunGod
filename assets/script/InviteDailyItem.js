cc.Class({
  ...
  setItemData: function (e, t) {
    ...
    if (this.title.string = '第' + (e + 1) + '个好友', this.rewardCount.string = 'x' + n.Value, this.showImg = this.node.getChildByName('strength'), this.showImg.active = !0, t == null) this.now.active = !1, this.mask.active = !0, this.isget.active = !1
    else {
