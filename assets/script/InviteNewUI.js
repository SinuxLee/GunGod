...
cc.Class({
  ...
  initContent: function () {
    for (let e = facade.getComponent('GameModel').newbieFetchList, t = 0; t < 4; t++) {
      const n = cc.instantiate(this.item)
      e[t] != null ? n.getComponent('InviteDailyItem1').setItemData(t, e[t]) : n.getComponent('InviteDailyItem1').setItemData(t, null), this.content.addChild(n)
    }
  },
  onClickInvite: function () {
    ...
    window.facade.getComponent('ShareADModel').showShareAD(e, {
      succ: function (e) {
        ...
        const t = facade.getComponent('GameModel').newbieFetchList
