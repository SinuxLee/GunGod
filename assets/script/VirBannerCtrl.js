...
module.exports = {
  ...
  init: function () {
    ...
    cc.systemEvent.on(t.MORE_GAME, this.checkVirBanner, this)
    ...
    i.target = n
    i.component = 'MainUI'
    i.handler = 'onClickBanner'
    this.virBannerNode.getComponent(cc.Button).clickEvents.push(i)
    n.addChild(this.virBannerNode)
  ...
  showVirBanner: function () {
    if (this.gameInfo) {
      ...
      e.banner != '' && e.banner && e.banner.indexOf('http') == 0 && cc.loader.load({
        ...
        t && (this.virBannerNode.active = true, this.virBannerNode.getComponent(cc.Sprite).spriteFrame = new cc.SpriteFrame(t), this.virBannerNode.zIndex = 99999, this.virBannerNode.getComponent(cc.Widget).bottom = 0, this.virBannerNode.getComponent(cc.Widget).updateAlignment())
      }.bind(this))
    }
  },
  hideVirBanner: function () {
    this.curShowName = '', this.virBannerNode && (this.virBannerNode.getComponent(cc.Sprite).spriteFrame = null, this.virBannerNode.zIndex = 1, this.virBannerNode.active = false), facade.getComponent('BannerModel').hideBanner()
  }
}
