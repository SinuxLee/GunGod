...
cc.Class({
  ...
  showResult: function (e) {
    this.backBtn.active = !0, cc.director.getScene().getChildByName('Canvas').getChildByName('recommendBar').zIndex = 1, window.facade.getComponent('LevelModel').resultLevel == window.facade.getComponent('LevelModel').playingLevel && (e != 0 && (e = !0), this.result.active = !0, this.result.getComponent('ResultPanel').init(e))
  },
