...
cc.Class({
  ...
  onLoad: function () {
    this.isInUI || this.isSuffer || (this.aim = new cc.Node(), this.aim.addComponent(cc.Sprite), this.aim.getComponent(cc.Sprite).spriteFrame = cc.loader.getRes('roles', cc.SpriteAtlas).getSpriteFrame('aim'), this.handGun.addChild(this.aim, 999), this.aim.active = !1, this.aim.scale = 0.5, this.aim.y = 10)
  },
  start: function () {
  ...
  onTouchStart: function (e) {
    ...
    this._inTouch = !0, this.isInUI || (this.line.active = !0, this.line.runAction(cc.repeatForever(cc.sequence(cc.fadeIn(0.5), cc.fadeOut(0.5))))), this.gunPos = this.handGun.convertToWorldSpaceAR(cc.v2()), this.gunDir = t.sub(this.gunPos)
