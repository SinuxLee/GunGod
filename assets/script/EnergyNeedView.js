...
cc.Class({
  ...
  initData: function () {},
  start: function () {
    this.rewardType = window.facade.getComponent('ShareADModel').getShareADType(), this.rewardType != 2 ? (this.btn.spriteFrame = this.videoSkin, this.title.string = '观看视频获得') : (this.btn.spriteFrame = this.shareSkin, this.title.string = '分享给朋友们获得')
  },
  close: function () {
