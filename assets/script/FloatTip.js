cc.Class({
  ...
  showTip: function (e) {
    this.floatNode == null
      ...
      : (this.floatNode.getChildByName('Label').getComponent(cc.Label).string = e, this.floatNode.stopAllActions(), this.floatNode.opacity = 255, this.floatNode.setPosition(0, 50), this.runFloat())
  },
  runFloat: function () {
