...
cc.Class({
  ...
  onLoad: function () {
    this.node.opacity = 0
    cc.systemEvent.on(ModuleEventEnum.CHARACTER_GOT, this.characterGot, this)
  },
  ...
  characterGot: function (e) {
    e == this.node.data && (this.effect.active = true, this.effect.getComponent(cc.ParticleSystem).resetSystem())
  },
