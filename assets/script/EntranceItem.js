cc.Class({
  ...
  start: function () {
    ...
    }.bind(this)), this.desc.string = this.itemData.desc, this.btn.getChildByName('strength').active = this.itemData.type == 1, this.btn.getChildByName('cash').active = !(this.itemData.type == 1), this.btn.getChildByName('Label').getComponent(cc.Label).string = this.itemData.act
  },
