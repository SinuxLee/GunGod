cc.Class({
  ...
  onLoad: function () {
    this.closeActTime = 0.18, this.normalBtn.scale = 1
  },
  ...
  initContent: function () {
    ...
    let t; let n = facade.getComponent('GameModel').fetchDays
    ...
    n == null && (n = 0), i == null && (i = 0), i >= o && (this.doubleBtn.active = !1, this.normalBtn.active = !1), n == 0 ? (this.title.string = '第1天', t = 1) : (t = n % 7 == 0 ? 7 : n % 7, i < o && (t = t == 7 ? 1 : t + 1), this.title.string = '第' + t + '天'), t == 7 && (o > i ? (this.sDayNow.active = !0, this.sDayIsGet.active = !1) : (this.sDayNow.active = !1, this.sDayIsGet.active = !0)), this.doubleBtn.active = o > i, this.normalBtn.active = o > i
  ...
  doAction: function () {
    this.title.node.runAction(cc.moveBy(0.3, cc.v2(-500, 0)).easing(cc.easeInOut(3))), this.uiName.runAction(cc.moveBy(0.3, cc.v2(500, 0)).easing(cc.easeInOut(3)))
    for (var e = cc.spawn(cc.fadeIn(0.3), cc.scaleTo(0.3, 1).easing(cc.easeIn(3))), t = cc.spawn(cc.fadeIn(0.3), cc.scaleTo(0.3, 1).easing(cc.easeIn(3))), n = [], i = [], o = this.content.children, a = 0; a < o.length; a++) a < 3 ? n.push(o[a]) : i.push(o[a])
  ...
  setupShare: function () {
    facade.getComponent('ShareADModel').getShareADType() != 2 ? this.doubleBtn.getChildByName('video').active = !0 : this.doubleBtn.getChildByName('share').active = !0
  },
