...
cc.Class({
  ...
  loaded: function (e, t) {
    for (const n in console.log('asset:', t), this.levelConfig = t.json, this.levelType = 1, this.levelConfigList = [], this.chaterConfigs = {}, this.levelConfig) this.levelConfigList.push(this.levelConfig[n]), this.chaterConfigs[this.levelConfig[n].Type + '_' + this.levelConfig[n].Chapter] == null && (this.chaterConfigs[this.levelConfig[n].Type + '_' + this.levelConfig[n].Chapter] = []), this.chaterConfigs[this.levelConfig[n].Type + '_' + this.levelConfig[n].Chapter].push(this.levelConfig[n])
  ...
  initShotData: function () {
    ...
    let o = 'level_1'
    t == 1 ? o = 'level_' + n : t == 2 && (o = 'vip_' + n), this.lastBullets = 1, this.bulletFilled = 1, this.shotedBullets = 0, cc.systemEvent.emit(i.LEVEL_ONE_SHOT_GO, o)
  },
