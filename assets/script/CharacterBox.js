...
cc.Class({
  ...
  pageChange: function (e, t) {
    if (console.log(e._curPageIdx), e._curPageIdx < this._curPageIdx) { for (let n = 0; n < this._curPageIdx - e._curPageIdx; n++) this.removeRight(), this.addLeft() } else e._curPageIdx, this._curPageIdx
