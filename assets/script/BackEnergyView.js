...
cc.Class((o(i = {
  ...
  start: function () {
    this.rewardType = window.facade.getComponent('ShareADModel').getShareADType(), this.rewardType != 2 ? this.btn.spriteFrame = this.videoSkin : this.btn.spriteFrame = this.shareSkin, this.rewardEnergyLabel.string = this.addValue
  },
  onEnable: function () {
